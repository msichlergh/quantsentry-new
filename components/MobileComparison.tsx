...
const capabilities = [
  ...
  ["Works across platforms", "Seven platforms on one layer, read only", "Eleven platforms listed, including MT4, MT5, cTrader, DXtrade and Match-Trader", "Sits inside a broker infrastructure suite", "Platform coverage varies by deployment"],
  ...
  ["Signal between firms", "Opt in, pseudonymised, live", "Shared database of 10,000 plus bad actor records", "Shared intelligence layer across member firms", "None published"],
  ["Business intelligence on the same data", "Revenue, products, payouts and orders on the layer that proves a ring", "Dashboards inside the CRM, including pass rates and revenue to payout", "Exposure and P&L analysis across the broker suite", "Not published"],
